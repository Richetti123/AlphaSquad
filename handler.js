...
//this.reply(m.chat, `🐈 𝑵𝑶 𝑻𝑰𝑬𝑵𝑬 𝑨𝑳𝑷𝑯𝑨 𝑪𝑶𝑰𝑵𝑺`, m)
this.sendMessage(m.chat, {text: `🐈 𝑵𝑶 𝑻𝑰𝑬𝑵𝑬 𝑨𝑳𝑷𝑯𝑨 𝑪𝑶𝑰𝑵𝑺`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' AlphaSquad ', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}, { quoted: m })         
continue     
}
			
m.exp += xp
if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
this.sendMessage(m.chat, {text: `${lenguajeGB['smsCont7']()} *${usedPrefix}buy*`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' AlphaSquad ', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}, { quoted: m })         
//this.reply(m.chat, `${lenguajeGB['smsCont7']()} *${usedPrefix}buy*`, m)
continue //Sin límite
}
if (plugin.level > _user.level) {
this.sendMessage(m.chat, {text: `${lenguajeGB['smsCont9']()} *${plugin.level}* ${lenguajeGB['smsCont10']()} *${_user.level}* ${lenguajeGB['smsCont11']()} *${usedPrefix}nivel*`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' AlphaSquad ', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}, { quoted: m })         
...
if (m.money)
m.reply(+m.money + ' 𝑨𝑳𝑷𝑯𝑨 𝑪𝑶𝑰𝑵𝑺 🐱 𝑼𝑺𝑨𝑫𝑶(𝑺)')  
break
}}} catch (e) {
console.error(e)
} finally {
...
"thumbnail": apii.data, 
"title": [wm, '🐱 AlphaSquad ' + gt + ' 🐱', '@clan_alpha_squad'].getRandom(),
...
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: lenguajeGB.smsAvisoAG().slice(0,-2), body: [wm, 'AlphaSquad ' + gt + ' 😻', 'wa.me/56955274723'].getRandom(), thumbnail: gataImg, sourceUrl: accountsgb }}}}, tg)
